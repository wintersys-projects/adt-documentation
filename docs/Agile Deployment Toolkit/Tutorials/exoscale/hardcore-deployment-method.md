...
BE AWARE THAT WHEN MAKING A HARDCORE STYLE DEPLOYMENT WITH LIVE_SSL="1" A NEW SSL CERTIFICATE IS PROVISIONED FOR EACH DEPLOYMENT AND YOU WILL RAPIDLY REACH ISSUANCE LIMITS ACROSS MULTIPLE DEPLOYMENTS WITH (FOR EXAMPLE, LETSENCRYPT) WHICH WILL CAUSE THE DEPLOYMENT TO FAIL
