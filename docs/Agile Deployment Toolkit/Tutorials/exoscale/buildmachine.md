...
- EXPEDITED BUILD STYLE:

Paste a copy of the script: [Initial Script](https://github.com/wintersys-projects/adt-build-machine-scripts/blob/main/templatedconfigurations/templateoverrides/OverrideScript.sh) into an open text file on your laptop.

- HARDCORE BUILD STYLE:

Paste a copy of your fully configured userdata script which you generated by following []() into an open text file on your laptop.
