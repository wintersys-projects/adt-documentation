...
THIS WILL INSTALL THE DEFAULT DEMO (please note the very first demo you install may take slightly longer to build because the SSL certificates are being generated and for subsequent deployments, to the same website URL, will be reused which is a faster process)
