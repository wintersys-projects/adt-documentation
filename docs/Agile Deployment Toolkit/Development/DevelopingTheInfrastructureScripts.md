...
On your build machine installation you will find a clone of your ${BUILD_HOME} directory in the /home/development directory.
...
2. When you are happy with your script alterations, you have two options 
...
/usr/sbin/push - this script will push the modifications you have made to your github branch you call this with a commit message - /usr/bin/push "commit message 1"
/usr/sbin/push-and-sync - this script will perform the push to git and the sync to the live directories in ${BUILD_HOME}
